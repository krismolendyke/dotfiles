...
A collection of [[http://en.wikipedia.org/wiki/Literate_programming][literate programming]] dotfiles created and maintained in [[http://www.gnu.org/software/emacs/][Emacs]] with [[http://orgmode.org/][Org mode.]]  As of [2025-01-12 Sun]
this document is focused on macOS only after I migrated Linux specific configuration to [[file:linux.org]].
