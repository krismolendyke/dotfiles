...
*** =PATH=
    ...
    #+BEGIN_SRC sh
      export PYTHON_USER_BASE=$(python2 -m site --user-base)
...
*** [[https://github.com/krismolendyke/oh-my-zsh/blob/master/themes/k20e.zsh-theme][Theme]]
    ...
    - [ ] Just call this =PROMPT_COMMAND= since that's what it is now
    - [ ] https://github.com/magicmonty/bash-git-prompt

    #+BEGIN_SRC sh
      k20e_aws_is_prod() {
          echo ${AWS_PROFILE} | grep '\-prod' &> /dev/null
      }
      ...
      k20e_aws_prompt_info() {
          ...
          if [[ -z ${AWS_PROFILE} ]]; then
              ...
              INFO=${INFO}${ZSH_THEME_AWS_PROMPT_PROD}${AWS_PROFILE}
          else
              INFO=${INFO}${ZSH_THEME_AWS_PROMPT}${AWS_PROFILE}
          fi
    ...
    #+BEGIN_SRC sh
      ...
      $(k20e_prompt_command_aws_profile)" \
      " $(k20e_virtual_env)\
      \n\$ " \
      " %s"'
    #+END_SRC
...
**** Bash Builtins
     ...
     For things like aliases, exports, function, etc.

     #+BEGIN_SRC sh
       if [ -e /usr/local/etc/bash_completion.d/bash-builtins ]; then
           source /usr/local/etc/bash_completion.d/bash-builtins
       fi
     #+END_SRC
...
**** Credentials
     ...
     #+BEGIN_SRC sh
       alias aws-unset="unset AWS_PROFILE AWS_PROFILE AWS_CREDENTIAL_FILE EC2_CERT EC2_PRIVATE_KEY"
       aws-unset
     #+END_SRC
