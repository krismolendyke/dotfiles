...
A [[http://en.wikipedia.org/wiki/Literate_programming][literate programming]] [[http://www.zsh.org/][Zsh]] configuration created and maintained in [[http://www.gnu.org/software/emacs/][Emacs]] with
