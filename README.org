...
** Secret Information
   ...
   Define a directory to keep secret information in.
...
** [[https://virtualenv.pypa.io/en/latest/][virtualenv]]
   ...
   Use Distribute instead of [[https://pythonhosted.org/setuptools/][setuptools]]:
   ...
   Distribute is no longer being maintained. -- [[https://pythonhosted.org/distribute/][distribute docs]]
   #+END_QUOTE
