...
**** =kubectl=, =k=, =kctl=, =kns=
     ...
     Completion for helper tools =kctl=, =kns=:
...
** =~/.skhdrc=
   ...
   #+BEGIN_SRC shell :shebang #!/bin/bash
     ...
     # focus window
     # shift + alt - w : chunkc tiling::window --focus west
     # shift + alt - s : chunkc tiling::window --focus south
     # shift + alt - n : chunkc tiling::window --focus north
     # shift + alt - e : chunkc tiling::window --focus east
