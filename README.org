...
* [[https://brew.sh/][Homebrew]]
  ...
  #+end_src
   ...
   #+begin_src sh
     # shellcheck source=/dev/null
     [ -e "$(brew --prefix)/etc/profile.d/bash_completion.sh" ] && source "$(brew --prefix)/etc/profile.d/bash_completion.sh"
   #+end_src
...
* =kubectl=, =k=, =kctx=, =kns=, =krew=
  ...
  #+begin_src sh
    # shellcheck source=/dev/null
    [ -e "$(brew --prefix)/etc/bash_completion.d/kubectl" ] && source "$(brew --prefix)/etc/bash_completion.d/kubectl" && complete -o default -F __start_kubectl k
  #+end_src
...
* [[https://github.com/nvm-sh/nvm][nvm]]
  ...
  #+begin_src sh
    if complete -v nvm >/dev/null 2>&1; then
        ...
        # shellcheck source=/dev/null
        [ -e "$(brew --prefix nvm)/etc/bash_completion.d/nvm" ] && source "$(brew --prefix nvm)/etc/bash_completion.d/nvm"
    fi
  #+end_src
...
* [[https://git-scm.com/][Git]]
  ...
  #+begin_src sh
    # shellcheck source=/dev/null
    [ -e "$(brew --prefix git)/etc/bash_completion.d/git-completion.bash" ] && source "$(brew --prefix git)/etc/bash_completion.d/git-completion.bash"
